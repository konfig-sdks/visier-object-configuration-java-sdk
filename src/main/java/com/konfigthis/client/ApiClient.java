...
import com.konfigthis.client.auth.OAuth;
import com.konfigthis.client.auth.RetryingOAuth;
import com.konfigthis.client.auth.OAuthFlow;
...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://vanity.api.visier.io";
    private String tokenUrl = "/v1/auth/oauth2/token";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "apikey"));
        authentications.put("BearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("CookieAuth", new ApiKeyAuth("cookie", "VisierASIDToken"));
        ...
        if (configuration != null) {
            ...
            if (configuration.cookieAuth != null) {
                this.setCookieAuth(configuration.cookieAuth);
            }
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth oauth = new RetryingOAuth(getTokenUrl(), clientId, OAuthFlow.PASSWORD, clientSecret, parameters);
        authentications.put("OAuth2Auth", oauth);
        return oauth;
    }
    ...
    public String getCookieAuth() {
        return ((ApiKeyAuth) this.getAuthentication("CookieAuth")).getApiKey();
    }

    public void setCookieAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("CookieAuth")).setApiKey(apiKey);
    }

    public void setCookieAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("CookieAuth")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/22222222.99201.1200/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://vanity.api.visier.io)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /v1/auth/oauth2/token)
     * @return An instance of OkHttpClient
     */
